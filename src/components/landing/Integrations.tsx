          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-3 sm:grid-cols-4 gap-4">
              {integrations.map((integration) => (
                <div
                  key={integration.id}
                  className="group bg-gray-50 hover:bg-white rounded-xl p-4 flex flex-col items-center justify-center gap-2 border border-gray-100 hover:border-gray-200 hover:shadow-md transition-all cursor-pointer"
                >
