...
export function HeroSection() {
  return (
    <section className="relative min-h-screen pt-24 md:pt-32 pb-16 overflow-hidden">
      ...
      <div
        className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-glow-purple/20 rounded-full blur-[100px] animate-pulse-glow"
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-4xl mx-auto mb-6">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-heading mb-6 text-balance leading-tight">
            Stop Chasing Clicks. <span className="gradient-text">Let AI Close Sales</span> For You.
          </h1>
        ...
        <div className="relative mb-16">
          ...
          <div className="hidden lg:block">
            <FloatingCard className="absolute -left-8 top-1/4 w-48" delay={0}>
            ...
            <FloatingCard className="absolute -right-8 top-1/3 w-52" delay={0.5} reverse>
              <div className="flex items-center gap-3">
            ...
            <FloatingCard className="absolute right-16 bottom-0 w-44" delay={1}>
              <div className="flex items-center gap-3">
